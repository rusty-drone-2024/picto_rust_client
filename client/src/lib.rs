...
pub fn run() -> Result<(), ClientError> {
    ...
    for i in 0..5 {
        send_message(
            &mut stream,
            UpdateMessageContent(1, 1, i, "Test".to_string()),
        )?;
    }
    ...
    for i in 0..8 {
        send_message(
            &mut stream,
            UpdateMessageContent(1, 2, i, "Test".to_string()),
        )?;
    }
    ...
    for i in 0..15 {
        send_message(
            &mut stream,
            UpdateMessageContent(1, 3, i, "Test".to_string()),
        )?;
    }
    ...
    for i in 0..2 {
        send_message(
            &mut stream,
            UpdateMessageContent(1, 4, i, "Test".to_string()),
        )?;
    }
    ...
    for i in 0..3 {
        send_message(
            &mut stream,
            UpdateMessageContent(2, 1, i, "Test".to_string()),
        )?;
    }
    ...
    for i in 0..12 {
        send_message(
            &mut stream,
            UpdateMessageContent(4, 1, i, "Test".to_string()),
        )?;
    }
    ...
    for i in 0..7 {
        send_message(
            &mut stream,
            UpdateMessageContent(4, 2, i, "Test".to_string()),
        )?;
    }
    ...
    for i in 0..20 {
        send_message(
            &mut stream,
            UpdateMessageContent(8, 1, i, "Test".to_string()),
        )?;
    }
